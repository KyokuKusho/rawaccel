...
#define RA_GET_LATENCY CTL_CODE(RA_DEV_TYPE, 0x88b, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define RA_RESET_LATENCY CTL_CODE(RA_DEV_TYPE, 0x88c, METHOD_BUFFERED, FILE_ANY_ACCESS)
